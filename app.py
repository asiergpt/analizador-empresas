...
def load_data():
    ...
    # Carga Alumni (Simplificada para el ejemplo)
    # Aquí iría tu lógica de Fernet, usamos el mock si no hay datos reales
    if df_alumni.empty:
         _, df_alumni = generate_mock_data()
