...
def standarize_numero_empleados(x):
    ...
    - Aproximado: "~500" → "500"
    - Categorías: "Microempresa" → "0-9", "Pequeña" → "10-49", etc.
    - Sin datos: 0
    """
    if pd.isna(x):
        return "0"
    ...
    # "70 (EINF)", "45 (Ranking)", "200 (Web Oficial)"
    numero_simple = re.match(r'^(\d+)', val_str)
    if numero_simple:
        return numero_simple.group(1)
    
    # ============ FALLBACK: Sin datos encontrados ============
    return "0"
...
# --- 8. PÁGINA: DETALLE ---
    ...
    if not row_data.empty:
        ...
        render_table(pd.DataFrame({
            ...
            "Empleados": [(safe_get_val(r, 'numero_empleados'))],
