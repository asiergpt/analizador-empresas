...
def load_data():
    ...
    try:
        if "encryption_key" in st.secrets:
            ...
            # Normalizar nombres de columnas (quita espacios extra y problemas de mayúsculas)
        ...
        # Se deja vacío df_alumni si falla
...
if df_main is not None:
    ...
    with tab_profesional:
        ...
        if df_alumni is None or df_alumni.empty:
            ...
            st.caption("Revisa la clave de encriptación en Secrets.")
        else:
            # Detección inteligente de columna Nombre
            ...
            if not col_nombre:
                ...
                if prof_list:
                    ...
                    if prof_seleccionado and col_empresa:
                        ...
                        if st.button(f"Ver Análisis de {empresa_del_prof} ->", use_container_width=True):
            ...
            with st.expander("🕵️ Ver datos cargados (Debug)"):
