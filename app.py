...
if st.session_state.page == 'home':
    ...
    ">
        <div style="display: flex; align-items: flex-start; gap: 15px;">
            ...
            <div>
                <div style="color: #E65100; font-weight: 700; font-size: 1.1rem; margin-bottom: 8px;">Información Importante</div>
                <div style="color: #BF360C; line-height: 1.6; font-size: 0.95rem;">
                    Los datos que aparecen son resultado del análisis mediante <b>inteligencia artificial</b> combinado con información pública de múltiples fuentes: prensa especializada, rankings empresariales, webs corporativas, registros públicos y otras fuentes abiertas. Aunque me esfuerzo por garantizar precisión, algunos datos pueden ser incompletos o incorrectos. Te recomiendo verificar información crítica directamente con las empresas.
                </div>
            </div>
        </div>
    </div>
