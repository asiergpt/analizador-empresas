...
st.set_page_config(
    page_title="Analizador de Empresas 360",
    page_icon="🏢",
    layout="wide",
...
if selected_empresa:
    ...
    c1, c2, c3 = st.columns(3)
    with c1:
        st.markdown('<div class="feature-card"><span class="feature-icon">📊</span><div class="feature-title">Análisis Financiero</div><div class="feature-desc">Facturación, empleados y viabilidad económica.</div></div>', unsafe_allow_html=True)
    with c2:
        st.markdown('<div class="feature-card"><span class="feature-icon">💻</span><div class="feature-title">Tech Stack</div><div class="feature-desc">Tecnologías, CTOs y equipos de ingeniería.</div></div>', unsafe_allow_html=True)
    with c3:
        st.markdown('<div class="feature-card"><span class="feature-icon">🤝</span><div class="feature-title">Alumni</div><div class="feature-desc">Localiza contactos clave en empresas objetivo.</div></div>', unsafe_allow_html=True)
